    ...
    <footer className="bg-black/40 border-t border-white/10 py-12 px-4">
      <div className="container mx-auto">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Nền tảng loyalty Web3 đầu tiên tại Việt Nam, biến điểm thưởng thành tài sản có giá trị thực.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/mvp-features" className="text-gray-300 hover:text-white transition-colors">
                  Tính năng MVP
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 text-center">
          <p className="text-gray-400">© 2024 Gom Gom. Tất cả quyền được bảo lưu.</p>
        </div>
      </div>
    </footer>
  )
